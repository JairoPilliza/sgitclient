...
import { Checkbox, Chip, Divider, FormControlLabel, Grid, InputLabel } from '@mui/material';
        ...
        <MainCard title="Liquidación de compra" >
            <Grid container spacing={gridSpacing}>
                ...
                <Grid item lg={12} md={12} sm={12} xs={12} >
                    <Divider><Chip label="Datos de Liquidación" /></Divider>
                    <br />
                    {/* <SubCard className="col-12" container title="Datos de Liquidación" style={{ textAlign: "center" }}> */}
                    <Grid container>
                        <Grid item lg={6} md={6} sm={12} xs={12}  >
                            <FormControl sx={{ minWidth: '100%', size:"small" }} size="small">
                ...
                <Grid item sm={12} xs={12} >
                    <Divider><Chip label="Calculo (Valor Liquido a Recibir)" /></Divider>
                    <br />
